...
Param(
    ...
    [string] $nugetFoldersPathGPF,
    [string] $nugetFoldersPathScratch,
...
Try
{
    ...
    SetupNuGetFolders $nugetClientFilePath $nugetFoldersPath   $nugetFoldersPathGPF $nugetFoldersPathScratch
...
Finally
{
    CleanNuGetFolders $nugetClientFilePath $nugetFoldersPath $nugetFoldersPathGPF $nugetFoldersPathScratch
}
