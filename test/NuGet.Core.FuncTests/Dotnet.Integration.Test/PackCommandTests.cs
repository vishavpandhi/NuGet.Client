    ...
    public class PackCommandTests
    {
        ...
        public void CreatePackageWithFiles()
        {
            ...
            using (var testDirectory = msbuildFixture.CreateTestDirectory())
            {
                ...
                msbuildFixture.RestoreProjectExpectSuccess(workingDirectory, projectName, string.Empty);
        ...
        public void PackCommand_NewProject_OutputsInDefaultPaths()
        {
            ...
            using (var testDirectory = TestDirectory.Create())
            {
                ...
                // Act
                msbuildFixture.CreateDotnetNewProject(testDirectory.Path, projectName, "classlib");
                msbuildFixture.PackProjectExpectSuccess(workingDirectory, projectName, string.Empty, null);
        ...
        public void PackCommand_NewSolution_OutputInDefaultPaths()
        {
            ...
            using (var testDirectory = msbuildFixture.CreateTestDirectory())
            {
                ...
                msbuildFixture.RestoreSolutionExpectSuccess(testDirectory, solutionName, string.Empty);
                ...
                // Act
                msbuildFixture.PackSolutionExpectSuccess(testDirectory, solutionName, string.Empty, null);
        ...
        public void PackCommand_NewSolution_ContinuousOutputInDefaultPaths()
        {
            ...
            using (var testDirectory = TestDirectory.Create())
            {
                ...
                msbuildFixture.RestoreSolutionExpectSuccess(testDirectory, solutionName, string.Empty);
                msbuildFixture.BuildSolutionExpectSuccess(testDirectory, solutionName, string.Empty);
      ...
      <BuildOutputInPackage Include=""abc.pdb"">
        ...
        public void PackCommand_PackSolution_AddsProjectRefsAsPackageRefs()
        {
            ...
            using (var testDirectory = msbuildFixture.CreateTestDirectory())
            {
                ...
                msbuildFixture.RestoreSolutionExpectSuccess(testDirectory, solutionName, args: string.Empty);
                // Act
                msbuildFixture.PackSolutionExpectSuccess(testDirectory, solutionName, args: string.Empty);
      ...
      <PrivateRepositoryUrl>https://github.com/NuGet/NuGet.Client.git</PrivateRepositoryUrl>
        ...
        public void PackCommand_PackageIcon_HappyPath_Warns_Succeeds()
        {
            ...
            using (var srcDir = msbuildFixture.Build(testDirBuilder))
            {
                ...
                var result = msbuildFixture.PackProjectExpectSuccess(projectBuilder.ProjectFolder, projectBuilder.ProjectName, string.Empty);
        ...
        public void PackCommand_PackageIcon_MissingFile_Fails()
        {
            ...
            {
                projectBuilder.Build(msbuildFixture, srcDir.Path);
                var result = msbuildFixture.PackProjectExpectFailure(projectBuilder.ProjectFolder, projectBuilder.ProjectName, string.Empty);
        ...
        public void PackCommand_PackageReadmeFile_BasicFunc_WithSymbol_Succeeds()
        {
            ...
            {
                projectBuilder.Build(msbuildFixture, srcDir.Path);
                msbuildFixture.PackProjectExpectSuccess(projectBuilder.ProjectFolder, projectBuilder.ProjectName, string.Empty);
