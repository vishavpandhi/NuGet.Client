...
EndGlobal";
        ...
        public void DotnetRestore_WithAuthorSignedPackage_Succeeds()
        {
            using (SimpleTestPathContext pathContext = _msbuildFixture.CreateSimpleTestPathContext())
            {
                ...
                _msbuildFixture.RestoreProjectExpectSuccess(workingDirectory, projectName, args: string.Empty);
            }
        }
...
";
            ...
            //Act
            var result = _msbuildFixture.RunDotnetExpectFailure(pathContext.WorkingDirectory, $"restore {projectA.ProjectPath} --source {packageSource2.FullName} --v detailed");
