...
namespace NuGet.Build.SdkResolver
{
    ...
    /// </summary>
    [EventSource(Name = "NuGet-Build-SdkResolver")]
    internal class NuGetSdkResolverEventSource : EventSource
    {
        ...
        /// <summary>
        /// Writes an event indicating that the <see cref="NuGet.Common.Migrations.MigrationRunner" /> has started.
        /// </summary>
        [Event(EventId.GetResultStart, Keywords = Keywords.All, Version = EventVersion)]
        public void MigrationRunnerStart()
        {
            WriteEvent(EventId.MigrationRunnerStart);
        }

        /// <summary>
        /// Writes an event indicating that the <see cref="NuGet.Common.Migrations.MigrationRunner" /> has completed.
        /// </summary>
        [Event(EventId.GetResultStop, Keywords = Keywords.All, Version = EventVersion)]
        public void MigrationRunnerStop()
        {
            WriteEvent(EventId.MigrationRunnerStop);
        }
        ...
        private static class EventId
        {
            ...
            public const int MigrationRunnerStart = 15;
            public const int MigrationRunnerStop = 16;
