...
namespace NuGet.Build.Tasks.Console
{
    ...
    internal static class MSBuildFeatureFlags
    {
        ...
        {
            get => string.Equals(Environment.GetEnvironmentVariable("MSBuildCacheFileEnumerations"), "1", StringComparison.InvariantCulture);
        ...
        {
            get => string.Equals(Environment.GetEnvironmentVariable("MSBuildLoadAllFilesAsReadonly"), "1", StringComparison.InvariantCulture);
        ...
        {
            get => !string.Equals(Environment.GetEnvironmentVariable("MSBuildSkipEagerWildCardEvaluationRegexes"), null, StringComparison.InvariantCulture);
