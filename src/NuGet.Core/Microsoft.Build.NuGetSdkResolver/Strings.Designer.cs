...
namespace Microsoft.Build.NuGetSdkResolver {
    ...
    internal class Strings {
        ...
        /// <summary>
        ///   Looks up a localized string similar to The NuGet-based MSBuild project SDK resolver did not resolve the SDK &quot;{0}&quot; because the resolver is disabled by the {1} environment variable..
        /// </summary>
        internal static string Error_DisabledExperimentalSdkResolver {
            get {
                return ResourceManager.GetString("Error_DisabledExperimentalSdkResolver", resourceCulture);
            }
        }
