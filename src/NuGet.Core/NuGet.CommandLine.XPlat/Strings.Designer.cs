...
namespace NuGet.CommandLine.XPlat {
    ...
    internal class Strings {
        ...
        /// <summary>
        ///   Looks up a localized string similar to You are passing a &apos;WORKING_DIRECTORY&apos; argument to config command. But the `{0}` does not exist or you don&apos;t have access to it..
        /// </summary>
        internal static string Error_WorkingDirectoryDoesNotExist {
            get {
                return ResourceManager.GetString("Error_WorkingDirectoryDoesNotExist", resourceCulture);
            }
        }
