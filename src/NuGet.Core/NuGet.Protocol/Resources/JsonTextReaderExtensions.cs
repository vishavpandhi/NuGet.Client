...
namespace Benchmarks.Readers
{
    internal static class JsonTextReaderExtensions
    {
        ...
        internal static bool ReadArray(this JsonTextReader reader, Action<string> onProperty)
        {
            return ReadArray(reader, onProperty, out int _0, out int _1);
        }

        internal static bool ReadArray(this JsonTextReader reader, Action<string> onProperty, out int startObjectLine, out int startObjectColumn)
        {
            startObjectLine = 0;
            startObjectColumn = 0;
